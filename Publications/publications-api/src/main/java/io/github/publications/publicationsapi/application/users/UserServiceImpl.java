...
public class UserServiceImpl implements UserService {
    ...
    @Override
    @Transactional
    public User savePwd(String email, String password) {
        var userResetPwd = getByEmail(email);
        userResetPwd.setPassword(password);
        encodePassword(userResetPwd);
        return userRepository.save(userResetPwd);
    }
